...
function generatePriceCardSVG(options) {
  ...
  const formatted = Number.isFinite(amount) ? formatDirham(amount, { locale, decimals, notation, useCode: true }).replace("AED", "").trim() : "\u2014";
  ...
  const symbolLeftX = isRTL ? cx + textHalfWidth + gap : cx - textHalfWidth - symbolSize - gap;
...
exports.generatePriceCardSVG = generatePriceCardSVG;
