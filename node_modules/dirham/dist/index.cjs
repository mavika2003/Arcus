...
exports.DIRHAM_CSS_CLASS = DIRHAM_CSS_CLASS;
exports.DIRHAM_CSS_CONTENT = DIRHAM_CSS_CONTENT;
exports.DIRHAM_CURRENCY_CODE = DIRHAM_CURRENCY_CODE;
exports.DIRHAM_FONT_FAMILY = DIRHAM_FONT_FAMILY;
exports.DIRHAM_HTML_ENTITY = DIRHAM_HTML_ENTITY;
exports.DIRHAM_STROKE_MAP = DIRHAM_STROKE_MAP;
exports.DIRHAM_SYMBOL_TEXT = DIRHAM_SYMBOL_TEXT;
exports.DIRHAM_UNICODE = DIRHAM_UNICODE;
exports.DIRHAM_WEIGHT_MAP = DIRHAM_WEIGHT_MAP;
exports.UAE_VAT_RATE = UAE_VAT_RATE;
exports.addVAT = addVAT;
exports.clearRateCache = clearRateCache;
exports.convertFromAED = convertFromAED;
exports.convertToAED = convertToAED;
exports.copyDirhamAmount = copyDirhamAmount;
...
exports.parseDirham = parseDirham;
exports.removeVAT = removeVAT;
