...
function DirhamPriceBase({
  ...
  const symbol = useCode ? /* @__PURE__ */ jsx(Text, { style: { color, fontSize }, children: "AED" }) : /* @__PURE__ */ jsx(DirhamSymbol, { size: symbolSize, color, weight });
  return /* @__PURE__ */ jsx(
    View,
    {
      style: {
      ...
      children: symbolFirst ? /* @__PURE__ */ jsxs(Fragment, { children: [
        symbol,
        /* @__PURE__ */ jsxs(Text, { style: { color, fontSize }, children: [
          "\xA0",
          formatted
        ] })
...
export { DirhamPrice, DirhamSymbol };
