...
// src/react-native/DirhamSymbol.tsx
...
var DirhamSymbol = react.memo(DirhamSymbolBase);
...
function DirhamPriceBase({
  ...
  const label = accessibilityLabel ?? formatDirham(amount, { locale, decimals, useCode: true, notation });
  const symbol = useCode ? /* @__PURE__ */ jsxRuntime.jsx(reactNative.Text, { style: { color, fontSize }, children: "AED" }) : /* @__PURE__ */ jsxRuntime.jsx(DirhamSymbol, { size: symbolSize, color, weight });
  return /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.View,
    {
      style: {
      ...
      children: symbolFirst ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        symbol,
        /* @__PURE__ */ jsxRuntime.jsxs(reactNative.Text, { style: { color, fontSize }, children: [
          "\xA0",
          formatted
        ] })
